...
function createApp() {
        ...
        inquirer.prompt([
            {
                ...
                message: "Please choose the type of team member to add:",
                choices: ["Engineer", "Intern", "There are no other team members to add"]
            }
        ]).then(chooseType => {
            switch(chooseType.chooseTeamMember) {
                case "Engineer":
                    addEngineer();
                    break;
                case "Intern":
    ...
    function addEngineer() {
        inquirer.prompt([
            ...
            teamArray.push(answers.engineerId);
            console.log("\n", "An engineer has been added to your team.", "\n");
            addNewMember();
        });
    }
    ...
    function addIntern() {
        inquirer.prompt([
            ...
            teamArray.push(answers.internId);
            console.log("\n", "An intern has been added to your team.", "\n");
            addNewMember();
        });
    }
